...
``` 
# pansharpening
python train_pansharpening_simulate.py --idx 2 --data_path ../../DataSet --dataset CAVE --epochs 100 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 10 --device 4 --noise_level 0.001 0.005
```

## ICVL
```
# pansharpening
python train_pansharpening_simulate.py --idx 4 --data_path ../../DataSet --dataset ICVL --epochs 10 --train_size 64 --stride 64 --batch_size 16 --lr_decay --save_freq 1 --device 6 --noise_level 0.001 0.005
```
...
```
# all
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_ps_model ./2/model/best_24.pth --noise_level 0.001 0.005

# assign
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_ps_model ./2/model/best_24.pth --noise_level 0.001 0.005 --data_id stuffed_toys_ms.mat
```

## ICVL
```
# all
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_ps_model ./4/model/best_5.pth --noise_level 0.001 0.005

# assign
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_ps_model ./4/model/best_5.pth --noise_level 0.001 0.005 --data_id nachal_0823-1040.mat
```

## RealWorld
```
# all
python generate.py --idx 1 --real_world --mosaic_save --pan_save --demosaic_save --data_path ../../DataSet/ --dataset real_world --load_ps_model ./6/model/best_40.pth

# assign
python generate.py --idx 1 --real_world --mosaic_save --pan_save --demosaic_save --data_path ../../DataSet/ --dataset real_world --load_ps_model ./6/model/best_40.pth --data_id 3.raw 42.raw 54.raw 
```

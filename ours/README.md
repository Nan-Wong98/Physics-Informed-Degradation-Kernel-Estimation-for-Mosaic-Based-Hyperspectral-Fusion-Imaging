...
## CAVE
``` 
# train for srf and psf
python train_simulate_for_srf_psf.py --idx 1 --data_path ../../DataSet --dataset CAVE --epochs 100 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 5 --device 2 --noise_level 0.001 0.005

# train
python train_simulate.py --idx 2 --data_path ../../DataSet --dataset CAVE --epochs 1000 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 50 --load_srf_psf ./1/model/100.pth --device 1 --noise_level 0.001 0.005
```

## ICVL
```
# train for srf and psf
python train_simulate_for_srf_psf.py --idx 3 --data_path ../../DataSet --dataset ICVL --epochs 10 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 5 --device 2 --noise_level 0.001 0.005

# train
python train_simulate.py --idx 4 --data_path ../../DataSet --dataset ICVL --epochs 10 --train_size 64 --stride 64 --batch_size 16 --lr_decay --save_freq 5 --load_srf_psf ./3/model/10.pth --device 2 --noise_level 0.001 0.005
```

## realworld dataset
```
# train for srf and psf
python train_realworld_for_srf_psf.py --idx 5 --data_path ../../DataSet --dataset real_world --epochs 10 --train_size 64 --stride 64 --batch_size 16 --lr_decay --save_freq 1 --device 6

# train
python train_realworld.py --idx 6 --data_path ../../DataSet --dataset real_world --epochs 10 --train_size 64 --stride 64 --batch_size 16 --lr_decay --load_srf_psf ./5/model/10.pth --save_freq 1 --visual --visual_freq 1 --device 6
```
...
```
# all
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_model ./2/model/best_272.pth --noise_level 0.001 0.005

# assign
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_model ./2/model/best_272.pth --noise_level 0.001 0.005 --data_id stuffed_toys_ms.mat
```

## ICVL
```
# all
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_model ./4/model/best_8.pth --noise_level 0.001 0.005

# assign
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_model ./4/model/best_8.pth --noise_level 0.001 0.005 --data_id nachal_0823-1040.mat
```

## RealWorld
```
# all
python generate.py --idx 1 --real_world --mosaic_save --pan_save --demosaic_save --data_path ../../DataSet/ --dataset real_world --load_model ./6/model/best_1.pth

# assign
python generate.py --idx 1 --real_world --mosaic_save --pan_save --demosaic_save --data_path ../../DataSet/ --dataset real_world --load_model ./6/model/best_1.pth --data_id 3.raw 42.raw 54.raw 
```

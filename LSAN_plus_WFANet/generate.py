...
def main(args):
    ...
    if args.load_ps_model == "" or args.load_ps_model == None:
        ...
        demosaic_net.load_state_dict(torch.load(args.load_demosaic_model, map_location="cpu"))
        print("==> Load pansharpening_net checkpoint: {}".format(args.load_ps_model))
        ps_net.load_state_dict(torch.load(args.load_ps_model, map_location="cpu"))
